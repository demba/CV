...
\begin{center} {\large \textbf{Deep Sparse Signal Representations: Theory, Applications, and a Signal Processing Perspective on Deep Neural Networks}}%Theory, Algorithms, and Applications to Multiscale Fusion}}
\end{center}
